**External Terminal** includes code that displays a graphic in the command palette that may be used to start a new Terminal.app window with the Workspace's path set as its working directory.
